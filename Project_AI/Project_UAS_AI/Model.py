...
def load_data():
    ...
    X = data.drop(columns=['num']).values  # Replace 'num' with your target column
    y = data['num'].astype(int).values  # Pastikan kolom target diubah menjadi tipe integer
    return X, y
...
def main(Input_data):
    ...
    def predict_heart_disease(input_data):
        # Ensure input matches the expected feature size
